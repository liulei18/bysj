...
<body>
	<div class="container">
		<div class="panel panel-default">
			...
			<div class="row">
				<form class="form-inline" action="manager/word/all" method="post" id="searchForm">
					<div class="col-md-8">
					...
					<div class="col-md-4">
					<a class="btn btn-default" href="<%=path%>/index" role="button">首页</a>
			...
			<table class="table table-hover table-condensed">
				...
				<tbody>
					<c:forEach items="${pageInfo.data}" var="item" varStatus="status">
						...
						<td>${item.zhMean }</td>
						<td>${item.enMean }</td>
						<td><a href='javascript:detail(${item.id })'>详细</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
	...
	<script type="text/javascript">
		...
		function detail(id){
			location.href = "manager/word/detail/"
				+ id;
